<article class="item item-md item-inset item-half" style="background-image: url(<?php echo esc_url( noozbeat_get_image_src( get_post_thumbnail_id(), 'noozbeat_featured' ) ); ?>);">
