<article class="item item-xs item-inset item-eighth" style="background-image: url(<?php echo esc_url( noozbeat_get_image_src( get_post_thumbnail_id(), 'noozbeat_featured' ) ); ?>);">
